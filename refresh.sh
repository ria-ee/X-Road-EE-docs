...
do
  ...
  diff -a -y --suppress-common-lines <(echo "## ${line}: *NIIS*"; cat v_$2/${line}.md) <(echo *EE*; cat v_$2/${line}.md)>> diff_$1.md
...
do
    ...
    then
        ...
        echo -e "${YELLOW} ${file_name}.md changed ${YELLOW}"
        diff -a -y --suppress-common-lines <(echo "## ${file_name}: *NIIS*"; cat v_$2/${file_name}.md) <(echo *EE*; cat md/${file_name}.md)  >> diff_$1.md
