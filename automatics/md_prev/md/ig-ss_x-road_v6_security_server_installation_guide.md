...
A guide to upgrading from an older version of X-Road can be found [here](https://abi.ria.ee/xtee/turvaserveri-uuendamine). Follow the chapter which contains your current X-Road version.
