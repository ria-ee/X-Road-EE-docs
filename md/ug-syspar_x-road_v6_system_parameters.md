...
The logged SOAP headers are the X-Road message headers listed in [Chapter 2.2](pr-mess_x-road_message_protocol.md#22-message-headers) of
...
The logged HTTP headers are the X-Road HTTP headers listed in [Chapter 4.3](pr-rest_x-road_message_protocol_for_rest.md#43-use-of-http-headers) of
